...
public class Dialog_ThemLoaiPhongHat extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_ThemLoaiPhongHat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_ThemLoaiPhongHat dialog = new Dialog_ThemLoaiPhongHat(new javax.swing.JFrame(), true);
